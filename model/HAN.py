...
class HANClassification(torch.nn.Module):
    def __init__(self, num_class, num_meta_paths, in_size, hidden_size, out_size, num_heads, dropout):
        super(HANClassification, self).__init__()
        self.num_class = num_class
        self.multiModelHAN = HAN(num_meta_paths, in_size, hidden_size, out_size, num_heads, dropout)
