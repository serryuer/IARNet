...
if __name__ == '__main__':
    ...
    model = BertForWeiboClassification(num_class=2, dropout=0.3, bert_path=BERT_PATH, finetune_bert=True, concat=False)
    ...
    trainer = Train(model_name='weibo_bert_avg',
                    ...
                    save_model_path=f"/sdd/yujunshuai/save_model/weibo_bert_avg",
